...
\item {Donde pone ``worlds/Morluck/world.xml'', debes cambiarlo a la ruta
correspondiente al fichero \textsf{world.xml} de tu aventura dentro del
archivo \textsf{.jar}.}
\item {Donde pone ``AgeCore.jar,lib/bsh-2.0b4.jar,lib/commons-cli-1.2.jar'',
...
\hline
\textsf{lib/svgSalamander.jar} & Aventuras con gráficos vectoriales svg \\
\hline
\end{tabular}
}
\end{enumerate}
