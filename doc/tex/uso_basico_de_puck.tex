...
\input{CrearMundosConPUCK.tex}
\input{CrearMundosResumen.tex}
\input{PrimerosPasos.tex}
\input{SeresInertes.tex}
...
Veamos ahora en más detalle cómo crear un mundo con PUCK. Empezaremos por los
\textit{Primeros Pasos: Creando Habitaciones y Caminos}.
