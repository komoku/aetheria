...
//Modified by Carlos Gomez Rodriguez
...
public class ClassManagerImpl extends BshClassManager
{
	...
	*/
	public ClassManagerImpl() {
		...
		//note that apart from adding classes to the class cache, we have to explicitly import them in stdfunct.bsh for this to work nicely.
		absoluteNonClasses.put("bsh","bsh");
		absoluteNonClasses.put("java","java");
		...
		absoluteClassCache.put("FileInputStream", java.io.FileInputStream.class);
		absoluteClassCache.put("InputStream", java.io.InputStream.class);
		absoluteClassCache.put("InputStreamReader", java.io.InputStreamReader.class);
		absoluteClassCache.put("Object", java.lang.Object.class);
		absoluteClassCache.put("BufferedReader", java.io.BufferedReader.class);
		absoluteClassCache.put("File", java.io.File.class);
		absoluteClassCache.put("URL", java.net.URL.class);
		absoluteClassCache.put("Thread", java.lang.Thread.class);
		...
		try
		{
		absoluteClassCache.put("Entity", Class.forName("eu.irreality.age.Entity"));
		absoluteClassCache.put("World", Class.forName("eu.irreality.age.World"));
		absoluteClassCache.put("Item", Class.forName("eu.irreality.age.Item"));
		absoluteClassCache.put("Mobile", Class.forName("eu.irreality.age.Mobile"));
		absoluteClassCache.put("Spell", Class.forName("eu.irreality.age.Spell"));
		absoluteClassCache.put("AbstractEntity", Class.forName("eu.irreality.age.AbstractEntity"));
		absoluteClassCache.put("Effect", Class.forName("eu.irreality.age.Effect"));
		absoluteClassCache.put("Inventory", Class.forName("eu.irreality.age.Inventory"));
		absoluteClassCache.put("MobileList", Class.forName("eu.irreality.age.MobileList"));
		absoluteClassCache.put("Player", Class.forName("eu.irreality.age.Player"));
		absoluteClassCache.put("BSHCodeExecutedOKException", Class.forName("eu.irreality.age.BSHCodeExecutedOKException"));
		absoluteClassCache.put("MultimediaInputOutputClient", Class.forName("eu.irreality.age.MultimediaInputOutputClient"));
		absoluteClassCache.put("InputOutputClient", Class.forName("eu.irreality.age.InputOutputClient"));
		absoluteClassCache.put("Random", Class.forName("java.util.Random"));
		absoluteClassCache.put("Debug", Class.forName("eu.irreality.age.debug.Debug"));
		absoluteClassCache.put("BshMethod", Class.forName("bsh.BshMethod"));
	...
	*/
	public Class classForName( String name )
	{
		...
		if ( name.equals("bsh") || name.endsWith(".bsh") )
			return null;
		if ( name.equals("java") || name.endsWith(".java") )
			return null;
		if ( name.equals("lang") || name.endsWith(".lang") )
			return null;
		if ( name.equals("io") || name.endsWith(".io") )
			return null;
		if ( name.equals("util") || name.endsWith(".util") )
			return null;
		...
		{
			System.err.println("Finding class: " + name);
